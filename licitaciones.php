...
<head>
    ...
    <title>Licitaciones - GesDoc</title>
...
<div class="container-fluid py-4 px-4">
    ...
    <div class="row mb-3">
        <div class="col-12 d-flex justify-content-between align-items-center">
            <div>
                <h2 class="mb-1" style="color:var(--primary-blue);">Consulta de Licitaciones</h2>
...
$(document).ready(function() {
    // Cargar filtros de empresa/consorcio
    $.get('api/licitaciones.php?action=get_filters', function(res) {
        res.companies.forEach(c => {
            $('#fCompany').append(`<option value="${c.id}" data-nit="${c.nit}">${c.name} (${c.nit})</option>`);
        });
        res.consortiums.forEach(c => {
    ...
    $('#fCompany').on('change', function() {
        ...
        const consorcios = [];
        $.get(`api/licitaciones.php?action=search&company_id=${val}&keyword=`, function(res) {
...
function runSearch() {
    ...
    $.get('api/licitaciones.php', params, function(res) {
    ...
    return [
        ...
        },
        {
            ...
            render: function(data, type, row) {
                ...
                return `<a href="api/licitaciones.php?action=download&id=${row.id}"
